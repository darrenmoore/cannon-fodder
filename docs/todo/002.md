...
- **Boot Hill** — [`boothill.ts`](../../game/src/boothill.ts). A cross per man
...
- **The roster persists** — [`campaign.ts`](../../game/src/campaign.ts). One
...
- **Promotions** — `Soldier.rank` had been declared, documented and read by
  ...
  (`veteranEdge` in [`troops.ts`](../../game/src/troops.ts)), tuned by
...
[`main.ts`](../../game/src/main.ts) or [`game.ts`](../../game/src/game.ts) were
